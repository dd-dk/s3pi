...
namespace CatalogResource
{
    public class ObjectCatalogResource : CatalogResourceTGIBlockList
    {
            ...
            : base(APIversion, basis)
        {
            ...
            this.mtDoorList = new MTDoorList(this, basis.mtDoorList);
            ...
            : base(APIversion, ltgib)
        {
            ...
            this.mtDoorList = new MTDoorList(this, mtDoorList);
        ...
        protected override void Parse(Stream s)
        {
            ...
            this.materialList = new MaterialList(this, s);
            ...
            this.mtDoorList = new MTDoorList(this, s);
        ...
        #region Sub-classes
        public class MTDoor : AApiVersionedFields, IEquatable<MTDoor>, ICloneableWithParent
        {
            #region Attributes
            ObjectCatalogResource parent = null;
            ...
            #region Constructors
            public MTDoor(ObjectCatalogResource parent, Stream s) { this.parent = parent; Parse(s); }
            public MTDoor(ObjectCatalogResource parent, MTDoor basis)
            {
                this.parent = parent;
            ...
            public MTDoor(ObjectCatalogResource parent, float[] unknown1, uint unknownX, uint wallMaskIndex)
            {
                this.parent = parent;
            ...
            public object Clone(object newParent) { return Clone(newParent as ObjectCatalogResource); }

            public object Clone(ObjectCatalogResource newParent) { return new MTDoor(newParent, this); }
            ...
            public float[] Unknown1
            {
                ...
                set
                {
                    ...
                    if (!ArrayCompare(unknown1, value)) { unknown1 = (float[])value.Clone(); parent.OnResourceChanged(this, new EventArgs()); }
                }
            }
            ...
            public uint WallMaskIndex { get { return wallMaskIndex; } set { if (wallMaskIndex != value) { wallMaskIndex = value; parent.OnResourceChanged(this, new EventArgs()); } } }
        ...
        public class MTDoorList : AResource.DependentList<MTDoor, ObjectCatalogResource>
        {
            #region Constructors
            public MTDoorList(ObjectCatalogResource parent) : base(parent, 256) { }
            public MTDoorList(ObjectCatalogResource parent, IList<MTDoor> mtDoorList) : base(parent, 256, mtDoorList) { }
            public MTDoorList(ObjectCatalogResource parent, Stream s) : base(parent, 256, s) { }
            #endregion

            #region Data I/O
            protected override uint ReadCount(Stream s) { return (new BinaryReader(s)).ReadByte(); }
            protected override MTDoor CreateElement(ObjectCatalogResource parent, Stream s) { return new MTDoor(parent, s); }
            ...
            public override object Clone(ObjectCatalogResource newParent) { return new MTDoorList(newParent, this); }

            public override void Add(MTDoor item)
            {
                if (Count >= 255) throw new InvalidOperationException();
                base.Add(item);
            }
            public override void Insert(int index, MTDoor item)
            {
                if (Count >= 255) throw new InvalidOperationException();
        ...
        public IList<Material> Materials { get { return materialList; } set { if (materialList != value) { materialList = value == null ? null : new MaterialList(this, value); } OnResourceChanged(this, new EventArgs()); } }
        ...
        public IList<MTDoor> MTDoors { get { return mtDoorList; } set { if (mtDoorList != value) { mtDoorList = value == null ? null : new MTDoorList(this, value); } OnResourceChanged(this, new EventArgs()); } }
