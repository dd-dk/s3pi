...
namespace CatalogResource
{
    public class RailingCatalogResource : CatalogResourceTGIBlockList
    {
        ...
        public RailingCatalogResource(int APIversion, RailingCatalogResource basis)
        ...
        public override object Clone() { return new RailingCatalogResource(requestedApiVersion, this); }
