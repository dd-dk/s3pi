...
namespace s3pi.Filetable
{
    ...
    public class SpecificResource : SpecificIndexEntry
    {
        ...
        /// otherwise <see cref="s3pi.WrapperDealer.WrapperDealer.GetResource(int, IPackage, IResourceIndexEntry, bool)"/> will determine the correct resource wrapper.</param>
